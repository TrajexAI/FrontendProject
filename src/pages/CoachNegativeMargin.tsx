...
const CoachNegativeMargin = () => {
  const [messages, setMessages] = useState<Array<Message>>([
    {
      content: "Your profit margin is negative for Product A and Product C, and this needs to be addressed as you are losing money by selling these products. It is worth exploring the variable costs for these products. There is a breakeven analysis in the product profitability screen to help you decide if you can sell more of these products to turn a profit, or if you should stop offering these products.",
      isUser: false,
    },
  ]);
...
export default CoachNegativeMargin;
